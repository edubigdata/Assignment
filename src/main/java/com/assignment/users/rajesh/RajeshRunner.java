package com.assignment.users.rajesh;
 ...
 */
public class RajeshRunner extends AbstractRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(RajeshRunner.class);

    public static void main(String[] args) throws Exception {
        RajeshRunner runner = new RajeshRunner();
        runner.run(args);
    }
